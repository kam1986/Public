...
> OBS! As for the lexer, the parser tables functions `fun args -> ret` can have any return type and they can differ in return type, i.e. dynamic typing. In some cases, it is needed to explicitly give types to return values and values inside the functions. 
